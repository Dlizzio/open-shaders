			...
			*pBytes = 0;
			try {
				...
				if (!Util::ShaderInclude::Read(pathStr, contents, error)) {
					Util::ShaderInclude::Report(sourcePath, "TrackingIncludeHandler", pFileName, pathStr, error);
					return E_FAIL;
				}
				...
				*pBytes = contents.size;
				...
				Util::ShaderInclude::Report(sourcePath, "TrackingIncludeHandler", pFileName, sourcePath,
